...
//         private byte[] _key;
//
//         public NKeys.PrefixByte Type { get; }
//
//         internal NKeyPair(byte[] publicKey, byte[] privateKey, NKeys.PrefixByte type)
//         {
//             _key = publicKey;
...
//         }
//
//         internal NKeyPair(byte[] userSeed, NKeys.PrefixByte type)
//         {
//             if (userSeed == null)
//             {
...
//
//         public string EncodedPublicKey => NKeys.Encode(Type, false, _key);
//
//         /// <summary>
...
//
//         public string EncodedSeed => NKeys.Encode(Type, true, _seed);
//
//         /// <summary>

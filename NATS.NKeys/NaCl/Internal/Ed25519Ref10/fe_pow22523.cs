...
namespace NATS.NKeys.NaCl.Internal.Ed25519Ref10
{
	internal static partial class FieldOperations
	{
		internal static void fe_pow22523(out FieldElement result, ref FieldElement z)
		{
			...
			FieldOperations.fe_sq(out t1, ref t0); for (i = 1; i < 2; ++i) FieldOperations.fe_sq(out t1, ref t1);
			...
			FieldOperations.fe_sq(out t1, ref t0); for (i = 1; i < 5; ++i) FieldOperations.fe_sq(out t1, ref  t1);
			...
			FieldOperations.fe_sq(out t1, ref  t0); for (i = 1; i < 10; ++i) FieldOperations.fe_sq(out t1, ref  t1);
			...
			FieldOperations.fe_sq(out t2, ref  t1); for (i = 1; i < 20; ++i) FieldOperations.fe_sq(out t2, ref  t2);
			...
			FieldOperations.fe_sq(out t1, ref t1); for (i = 1; i < 10; ++i) FieldOperations.fe_sq(out t1, ref t1);
			...
			FieldOperations.fe_sq(out t1, ref  t0); for (i = 1; i < 50; ++i) FieldOperations.fe_sq(out t1, ref  t1);
			...
			FieldOperations.fe_sq(out t2, ref  t1); for (i = 1; i < 100; ++i) FieldOperations.fe_sq(out t2, ref  t2);
			...
			FieldOperations.fe_sq(out t1, ref t1); for (i = 1; i < 50; ++i) FieldOperations.fe_sq(out t1, ref t1);
			...
			FieldOperations.fe_sq(out t0, ref  t0); for (i = 1; i < 2; ++i) FieldOperations.fe_sq(out t0, ref t0);

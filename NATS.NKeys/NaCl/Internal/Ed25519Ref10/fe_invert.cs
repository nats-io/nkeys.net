...
namespace NATS.NKeys.NaCl.Internal.Ed25519Ref10
{
	internal static partial class FieldOperations
	{
		internal static void fe_invert(out FieldElement result, ref FieldElement z)
		{
			...
			FieldOperations.fe_sq(out t2, ref t1); for (i = 1; i < 5; ++i) FieldOperations.fe_sq(out t2, ref t2);
			...
			FieldOperations.fe_sq(out t2, ref t1); for (i = 1; i < 10; ++i) FieldOperations.fe_sq(out t2, ref t2);
			...
			FieldOperations.fe_sq(out t3, ref t2); for (i = 1; i < 20; ++i) FieldOperations.fe_sq(out t3, ref t3);
			...
			FieldOperations.fe_sq(out t2, ref t2); for (i = 1; i < 10; ++i) FieldOperations.fe_sq(out t2, ref t2);
			...
			FieldOperations.fe_sq(out t2, ref t1); for (i = 1; i < 50; ++i) FieldOperations.fe_sq(out t2, ref t2);
			...
			FieldOperations.fe_sq(out t3, ref t2); for (i = 1; i < 100; ++i) FieldOperations.fe_sq(out t3, ref t3);
			...
			FieldOperations.fe_sq(out t2, ref t2); for (i = 1; i < 50; ++i) FieldOperations.fe_sq(out t2, ref t2);
			...
			FieldOperations.fe_sq(out t1, ref t1); for (i = 1; i < 5; ++i) FieldOperations.fe_sq(out t1, ref t1);
